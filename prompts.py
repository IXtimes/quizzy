...
REQUEST_EXAMPLE_GRADE_ESSAY_GUIDELINES = """- The question and how it is to be graded, its guidelines, and a response, followed by a request to CRITICALLY grade the response according to the provided guidelines OUT OF TEN.
                                        Ex. Graded as an explaination; Question: "Describe the effect of increased biodiversity on the resilience of an ecosystem in a changing environment." Guidelines: "The response states that the ecosystem resilience will be greater with an increased biodiversity"
                                            - Ex 1. Input: "An increased biodiversity could increase the resilience of an ecosystem in a changing environment due to some factors, but it depends on the situation. (...)"
                                                Your response: "5~ Your response touches on the idea that increased biodiversity could lead to greater ecosystem resilience, which aligns with the question's guidelines. However, you miss providing a clear, direct statement that explicitly connects increased biodiversity with greater resilience, which the guidelines require. Additionally, while you mention cases where small ecosystems have survived, you don't fully explain how this relates to the overall concept of biodiversity and resilience, and you introduce ambiguity by saying "it depends on the situation." Make sure to clarify how biodiversity directly influences resilience in ecosystems."
                                            - Ex 2. Input: "An increased biodiversity directly increases the resistance of an ecosystem especially in a changing environment. With increased biodiversity, there is a wider diversity of organisms and interspecies relationships that support each other, even during a rapidly changing environment. The variety minimizes the potential of a complete extinction of the ecosystem due to extreme changing conditions."
                                                Your response: "10~ You have effectively addressed the guideline by stating that ecosystem resilience increases with biodiversity, which is the core of the question. Your explanation about how increased biodiversity leads to a greater variety of organisms and interspecies relationships that support each other in a changing environment is clear and directly linked to the resilience of the ecosystem. You also correctly mention how biodiversity minimizes the potential for extinction, which strengthens your argument." 
                                            - Ex 3. Input: "0~ Your response contradicts the guideline which explicitly states that ecosystem resilience will be greater with increased biodiversity. According to the provided guideline, you should have described how biodiversity boosts resilience, not decreases it. Therefore, your answer does not meet the expectations outlined and misses the key point of the question."
                                        Your evaulation should be CRITICAL and written in the 2nd person addressing the user who wrote the response, and the grade given be OUT OF TEN. The reasoning for your grade, which follows the grade after a '~' seperator, should be a breif 3-4 sentences explaining why that grade was given. Explicitly reference what parts of the guidelines the respone does well at addressing as well as what they miss. DO NOT ADDRESS THESE GUIDELINES VAUGELY. Your evaluation MUST ONLY PURELY take into account the GUIDELINES that are provided. DO NOT PENALIZE FOR ANY ADDITIONAL CRITERION POSSIBLY MISSED IF ITS NOT INCLUDED IN THE PROVIDED GUIDELINES, THEY ARE YOUR ABSOLUTE GRADING GUIDE! For responses that adhere to the guidelines, reward full credit, and for responses that fail to meet ANY guidelines reward no credit. For wrong answers that fail to meet the guidelines, provide insight as to why guideline matching answers are correct in the current context"""
REQUEST_GRADE_ESSAY_GUIDELINES = "Please grade THIS response and provide feedback given the question and guidelines."
