...
REQUEST_EXAMPLE_GRADE_ESSAY_GUIDELINES_HARD = """- The question and how it is to be graded, its guidelines, and a response, followed by a request to CRITICALLY grade the response according to the provided guidelines OUT OF TEN.
                                        Ex. Graded as an explaination; Question: "Describe the effect of increased biodiversity on the resilience of an ecosystem in a changing environment." Guidelines: "The response states that the ecosystem resilience will be greater with an increased biodiversity"
                                            - Ex. Input: "An increased biodiversity directly increases the resistance of an ecosystem especially in a changing environment. With increased biodiversity, there is a wider diversity of organisms and interspecies relationships that support each other, even during a rapidly changing environment. The variety minimizes the potential of a complete extinction of the ecosystem due to extreme changing conditions."
                                                Your response: "7~ Your response correctly identifies that increased biodiversity contributes to greater ecosystem resilience and provides some reasoning, such as the presence of diverse organisms and interspecies relationships. This aligns with the guideline that resilience is greater with increased biodiversity. However, your explanation lacks depth in addressing how these relationships specifically support resilience, especially in the context of a changing environment. For instance, you could elaborate on mechanisms like niche complementarity or redundancy, where species can compensate for each other’s roles when conditions change. To improve, provide more specific examples or mechanisms that explain why biodiversity minimizes ecosystem collapse and address the relationship between biodiversity and ecosystem functions more clearly. This would demonstrate a stronger understanding of the topic." 
                                        Your evaulation should be CRITICAL and written in the 2nd person addressing the user who wrote the response, and the grade given be OUT OF TEN. The reasoning for your grade, which follows the grade after a '~' seperator, should be a brief 3-4 sentences explaining why that grade was given. Explicitly reference what parts of the guidelines the respone does well at addressing as well as what they miss. DO NOT ADDRESS THESE GUIDELINES VAUGELY. Only for excellent responses that show a full understanding of the content the question is testing over, reward full credit, and for responses that fail to meet ANY guidelines reward no credit. For wrong answers, provide insight on how to write a correct response in the current context"""
REQUEST_EXAMPLE_GRADE_ESSAY_GUIDELINES_MEDIUM = """- The question and how it is to be graded, its guidelines, and a response, followed by a request to FAIRLY, but FORGIVINGLY grade the response according to the provided guidelines OUT OF TEN.
                                        Ex. Graded as an explaination; Question: "Describe the effect of increased biodiversity on the resilience of an ecosystem in a changing environment." Guidelines: "The response states that the ecosystem resilience will be greater with an increased biodiversity"
                                            - Ex. Input: "An increased biodiversity directly increases the resistance of an ecosystem especially in a changing environment. With increased biodiversity, there is a wider diversity of organisms and interspecies relationships that support each other, even during a rapidly changing environment. The variety minimizes the potential of a complete extinction of the ecosystem due to extreme changing conditions."
                                                Your response: "9~ Your response does a great job of adhering to the core guideline, clearly stating that increased biodiversity leads to greater resilience in an ecosystem within a changing environment. This aligns well with the requirement to highlight the positive relationship between biodiversity and ecosystem resilience. Additionally, you effectively elaborate on how diversity in species and their relationships contributes to minimizing extinction risks. However, your explanation could be slightly more specific in terms of mechanisms. For instance, mentioning examples such as genetic diversity aiding adaptation, or how diverse food webs prevent cascading collapses, would strengthen the response further. With these refinements, your answer would achieve full marks." 
...
REQUEST_EXAMPLE_GRADE_ESSAY_GUIDELINES_EASY = """- The question and how it is to be graded, its guidelines, and a response, followed by a request to LIENIANTLY grade the response according to the provided guidelines OUT OF TEN.
                                        Ex. Graded as an explaination; Question: "Describe the effect of increased biodiversity on the resilience of an ecosystem in a changing environment." Guidelines: "The response states that the ecosystem resilience will be greater with an increased biodiversity"
                                            - Ex. Input: "An increased biodiversity directly increases the resistance of an ecosystem especially in a changing environment. With increased biodiversity, there is a wider diversity of organisms and interspecies relationships that support each other, even during a rapidly changing environment. The variety minimizes the potential of a complete extinction of the ecosystem due to extreme changing conditions."
                                                Your response: "10~ Your response does an excellent job addressing the guidelines. It clearly establishes that increased biodiversity enhances ecosystem resilience, directly linking it to the capacity of ecosystems to adapt to changing environments. You effectively highlight the importance of interspecies relationships and diversity in preventing ecosystem collapse, which is central to the question's intent. To refine your response, consider providing specific examples of how biodiversity contributes to resilience, such as the role of diverse plant species in maintaining soil stability or how predator-prey dynamics can regulate populations. This added depth could make your answer even more compelling. Overall, great work!" 
                                        Your evaulation should be CONSTRUCTIVE, SUPPORTIVE, but most importantly LIENIANT, and written in the 2nd person addressing the user who wrote the response, and the grade given be OUT OF TEN. The reasoning for your grade, which follows the grade after a '~' separator, should be a brief 3-4 sentences explaining why that grade was given. Explicitly reference what parts of the guidelines the response does well at addressing as well as what they miss. DO NOT ADDRESS THESE GUIDELINES VAUGELY. Responses that are even just on the right track should be given FULL credit, and any impartialness should be discarded in favor of supporting answers that are on the right track. Answers that are completely off the mark and irrelevant to the question should be given no credit. While this is not greatly considered in your grade, still provide insight on how to write a better response in the current context."""
